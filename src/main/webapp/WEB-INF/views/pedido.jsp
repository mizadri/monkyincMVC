				...
				<div id="main">
					...
					<div id="content">
						...
						<form action="${prefix}addPedido" method="post">
							...
							<p>Modelo: </p> ${producto.descripcion}
							<br><br><p>Precio: </p>$${producto.precio}
							<br><br><label>Cantidad</label>
							<input type="hidden" name="producto" value="${producto.id}"></input>
							<input type="text" name="cantidad"></input><br><br>
							<input class="buttom" name="submit" id="submit" value="Pedir" type="submit">
						</form>
						<!-- End Content -->
					</div>
					<div class="cl">&nbsp;</div>
