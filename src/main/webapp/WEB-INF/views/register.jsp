			...
			<div id="main">
				...
				<div class="form">
					<form action="${prefix}addUser" id="contactform" method="post">
						...
						<input id="name" name="name" placeholder="Nombres" required type="text">
						<p class="contact"><label for="surname">Apellidos</label></p>
						<input id="surname" name="surname" placeholder="Apellidos" required type="text">
						...
						<p class="contact"><label for="adress">Dirección</label></p>
						<input id="adress" name="adress" placeholder="Dirección" required type="text">
						<p class="contact"><label for="phone">Teléfono</label></p>
						<input id="phone" name="phone" placeholder="Teléfono" required type="text"> 
						<br>
						<input class="buttom" name="submit" id="submit" tabindex="5" value="¡Registrarse!" type="submit">
